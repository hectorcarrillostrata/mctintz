...
const BlogGallery = dynamic(()=>import('../components/blog/blog-gallery'),{ssr:false})
      ...
      <div className="container">
          <div className="row">
              <div className="col-lg-8 col-md-7">
                  <BlogGallery/>
                  <div className="card border-0 shadow rounded mt-4">
                      <div className="card-body">
                          <div className="text-center">
                              <span className="badge text-bg-primary">Photography</span>
                              <h4 className="mt-3">Get Ready To Up Your <br/> Creative Game With The New DJI Mavic Air 2</h4>

                              <ul className="list-unstyled mt-3">
                                  <li className="list-inline-item user text-muted me-2"><i className="mdi mdi-account"></i> Cristina Jota</li>
                                  <li className="list-inline-item date text-muted"><i className="mdi mdi-calendar-check"></i> 31st Aug, 2026</li>
                              </ul>
                          </div>
