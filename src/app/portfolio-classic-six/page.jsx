...
import ClassicPortfolio from '../components/portfolio/classic-portfolio'
...
export default function ClassicSix() {
  return (
    ...
    <ClassicPortfolio col="row row-cols-md-2 row-cols-lg-6 mt-4 pt-2" grid="col spacing picture-item" container="container-fluid"/>
