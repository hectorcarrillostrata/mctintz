...
import {FiUser, FiUserCheck, FiKey, FiMail} from 'react-icons/fi'
import BackToHome from '../components/back-to-home'

export default function AuthSignupThree() {
  return (
    <>
                                ...
                                <form className="login-form mt-4">
                                    <div className="row">
                                        ...
                                        <div className="mx-auto">
                                            <p className="mb-0 mt-3"><small className="text-dark me-2">Already have an account ?</small> <Link href="/auth-login-three" className="text-dark fw-bold">Sign in</Link></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
