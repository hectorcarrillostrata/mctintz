              ...
              <div className="col-lg-12 text-center">
                  <div className="pages-heading">
                      ...
                      <ul className="list-unstyled mt-4 mb-0">
                          ...
                          <li className="list-inline-item h6 date text-muted"><i className="mdi mdi-calendar-check"></i> 19th June 2026</li>
                      </ul>
                  </div>
              </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-8 col-md-6">
              <div className="card blog blog-detail border-0 shadow rounded">
                  <Image src="/images/blog/01.jpg" width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid rounded-top" alt=""/>
