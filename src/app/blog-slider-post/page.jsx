                     ...
                     <BlogImageSlider/>
                      ...
                      <div className="card-body">
                          <div className="text-center">
                              ...
                              <h4 className="mt-3">The Morning After: Uber sets its sights on Postmates</h4>

                              <ul className="list-unstyled mt-3">
                                  <li className="list-inline-item user text-muted me-2"><i className="mdi mdi-account"></i> Cristina Jota</li>
                                  <li className="list-inline-item date text-muted"><i className="mdi mdi-calendar-check"></i> 20th June, 2026</li>
                              </ul>
                          </div>
