...
export default function NftItemDetail({params}) {
    const {id} = use(params)
    let data = nftProduct.find((item)=>item.id === parseInt(id))
  return (
    <>
    <NftNavbar/>
                ...
                <div className="col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div className="nft nft-primary">
                        ...
                        <div className="d-flex align-items-center mt-3">
                            <Image src={data?.clientImg} width={45} height={45} className="avatar avatar-md-sm rounded-pill shadow" alt=""/>
