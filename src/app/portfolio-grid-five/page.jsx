...
import GridPortfolio from '../components/portfolio/grid-portfolio'
...
export default function GridFive() {
  return (
    ...
    <GridPortfolio col="row row-cols-md-2 row-cols-lg-5" grid="col spacing picture-item mt-4 py-0" container="container-fluid"/>
