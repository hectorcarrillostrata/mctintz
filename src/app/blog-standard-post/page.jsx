          ...
          <div className="row">
              <div className="col-lg-8 col-md-7">
                  <div className="card border-0 shadow rounded overflow-hidden">
                      <Image src="/images/blog/standard.jpg" width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid" alt=""/>
                      ...
                      <div className="card-body">
                          <div className="text-center">
                              ...
                              <ul className="list-unstyled mt-3">
                                  ...
                                  <li className="list-inline-item date text-muted"><i className="mdi mdi-calendar-check"></i> 19th June, 2026</li>
                              </ul>
                          </div>
                          ...
                          <div className="post-meta mt-3">
                              <ul className="list-unstyled mb-0">
                                  ...
                                  <li className="list-inline-item"><Link href="#" className="text-muted comments"><FiMessageCircle className="me-1"></FiMessageCircle>08</Link></li>
                              </ul>
                          </div>
                      </div>
                  </div>
