...
export default function BlogLeftSidebarPost() {
  return (
    <>
    <BlogNavbar/> 
          ...
          <div className="row">
              <div className="col-lg-8 col-md-7 order-1 order-md-2">
                  <div className="card border-0 shadow rounded overflow-hidden">
                      <Image src="/images/blog/slide01.jpg" width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid" alt=""/>
