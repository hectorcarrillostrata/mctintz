  ...
  return (
          <div style={{marginTop:'50px'}}>
            <table cellPadding="0" cellSpacing="0" style={{fontFamily: 'Nunito, sans-serif', fontSize: '15px', fontWeight:' 400', maxWidth: '600px', border: 'none', margin: '0 auto', borderRadius: '6px', overflow: 'hidden', backgroundColor: '#fff', boxShadow: '0 0 3px rgba(60, 72, 88, 0.15)'}}>
                <thead>
                    <tr style={{backgroundColor: '#2f55d4', padding: '3px 0', border: 'none', lineHeight: '68px', textAlign: 'center', color: '#fff', fontSize: '24px', letterSpacing: '1px'}}>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style={{padding: '15px 24px'}}>
                            <Link href="#" style={{padding: '8px 20px', outline: 'none', textDecoration: 'none', fontSize: '16px', letterSpacing: '0.5px', transition: 'all 0.3s', fontWeight: '600', borderRadius: '6px', backgroundColor: '#2f55d4', border: '1px solid #2f55d4', color: '#ffffff'}}>Confirm Email Address</Link>
                        </td>
                    </tr>
