...
export default function HostingBlogDetail({params}) {
    let {id} = use(params)
    let data = hostingBlog.find((item)=>item.id === parseInt(id))
  return (
    <>
    <HostingNavbar/>
          ...
          <div className="row mt-5 justify-content-center">
              <div className="col-lg-12 text-center">
                  <div className="pages-heading title-heading">
                      <h4 className="title text-white title-dark mb-4"> {data?.title}</h4>
