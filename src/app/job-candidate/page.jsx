...
import { jobSkills, jobSocial } from '../data/job'
                ...
                <div className="col-lg-4 col-md-5 col-12">
                    <div className="card job-profile shadow border-0">
                        <div className="text-center py-5 border-bottom rounded-top">
                            <Image src="/images/client/01.jpg" width={110} height={110} className="avatar avatar-medium mx-auto rounded-circle shadow d-block" alt=""/>
                        ...
                        <div className="card-body">
                            ...
                            <ul className="list-unstyled">
                                <li className="h6 mb-3"><FiMail className="fea icon-sm text-warning me-3"/><span className="text-muted">Email :</span> thomas@mail.com</li>
