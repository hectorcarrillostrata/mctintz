  ...
  return (
    <div className="row justify-content-center mt-4 pt-2">
        <div className="col-lg-8 col-12">
            <div className="p-4 shadow rounded" role="form">
                ...
                <div className="row">
                    <div className="col-sm-12 mb-4">
                        ...
                        <input type="range" defaultValue="10000" min="10000" max="200000" className="form-range custom-range" id="slider" onInput={handleChange}/>
                    </div>
                </div>
                ...
                <ul className="list-unstyled text-center d-md-flex justify-content-between mb-0">
                    ...
                    <li className="mt-2 mt-sm-0">
                        <ul className="mb-0 text-md-end brokerage-form list-unstyled">
                            ...
                            <li className="h5 mb-0"><input type="hidden" id="saving" className="form-control mb-0"/> <p className="mb-0 d-inline-block h5 text-primary" id="saving-label"></p></li>
                        </ul>
                    </li>
                </ul>
            </div>
