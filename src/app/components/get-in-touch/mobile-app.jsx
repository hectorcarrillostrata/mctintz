  ...
  return (
        <div className="row align-items-center">
            <div className="col-lg-5 col-md-5 col-12">
                <Image src="/images/illustrator/envelope.svg" width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid mx-auto d-block" alt=""/>
            </div>
            ...
            <div className="col-lg-7 col-md-7 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="section-title">
                    <div className="alert alert-light alert-pills text-dark" role="alert">
                        ...
                        <span className="content">Download now <FiChevronRight className=""/></span>
                    </div>
                    ...
                    <div className="my-4">
                        <Link href="#">
                            <Image src="/images/app/app.png" className="m-1" width={167} height={50} alt=""/>
                        </Link>
                    ...
                    <div className="d-inline-block">
                        <div className="pt-4 d-flex align-items-center border-top">
                            ...
                            <div className="content">
                                ...
                                <Link href="#" className="text-primary h6">Learn More <FiChevronRight className=""/></Link>  
                            </div>
                        </div>
                    </div>
                </div>
