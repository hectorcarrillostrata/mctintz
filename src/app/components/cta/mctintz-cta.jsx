...
export default function MctintzCta() {
  return (
        <section className="section" style={{backgroundImage:`url(${'/images/mctintz_comingsoon2.jpg'})`, backgroundAttachment:'fixed', backgroundPosition:'center', backgroundSize:'cover'}}>
