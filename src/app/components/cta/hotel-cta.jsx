...
export default function HotelCta() {
  return (
        <section className="section bg-cta" style={{backgroundImage:"url('/images/hotel/bg04.jpg')", backgroundPosition:'center'}} id="cta">
            <div className="bg-overlay"></div>
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-12 text-center">
                        <div className="section-title">
                            <h4 className="title title-dark text-white mb-4">Resembling Tour of Landrick Resort</h4>
