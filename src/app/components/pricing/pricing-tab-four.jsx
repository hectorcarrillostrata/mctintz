...
export default function PricingTabFour() {
            ...
            <div className="col-12 mt-4 pt-2">
                <div className="text-center">
                    <ul className="nav nav-pills rounded-pill justify-content-center d-inline-block border py-1 px-2">
                        ...
                        <li className="nav-item d-inline-block">
                            <Link href="#" scroll={false} className={`nav-link px-3 rounded-pill yearly ${activeTab === 2 ? 'active' : ''}`} onClick={()=>setActiveTab(2)}>Yearly <span className="badge rounded-pill bg-success">15% Off </span></Link>
                        </li>
                    </ul>
                </div>
