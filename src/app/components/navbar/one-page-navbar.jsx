...
export default function OnePageNavbar() {
                ...
                <div id="navigation" className={toggle ? 'd-block' : 'd-none'}>
                    <ul className="navigation-menu" id="navmenu-nav">
                        <li className="has-submenu">
                            <Link1 activeClass="active" to="home" spy={true} >Home</Link1>
                        </li>
                        <li className="has-submenu">
                            <Link1 activeClass="active" to="service" spy={true} >Feature</Link1>
                        </li>
                        <li className="has-submenu">
                            <Link1 activeClass="active" to="testimonial" spy={true} >Review</Link1>
                        </li>
                        <li className="has-submenu">
                            <Link1 activeClass="active" to="pricing" spy={true} >Price</Link1>
                        </li>
                        <li className="has-submenu">
                            <Link1 activeClass="active" to="contact" spy={true} >Contact</Link1>
                        </li>
                    </ul>
                </div>
            </div>
