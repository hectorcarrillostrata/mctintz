...
export default function CryptoNavbar({navlight}) {
             ...
             (
                ...
                <ul className="buy-button list-inline mb-0">
                    <li className="list-inline-item mb-0">
                        <Link href="#" onClick={()=>setShow(!show)}>
                            <div className="login-btn-primary"><span className="btn btn-icon btn-pills btn-soft-primary"><FiSettings className="feLink icon-sm"/></span></div>
                            <div className="login-btn-light"><span className="btn btn-icon btn-pills btn-light"><FiSettings className="feLink icon-sm"/></span></div>
                        </Link>
                    </li>
                    
                    <li className="list-inline-item ps-1 mb-0">
                        <Link href="https://1.envato.market/landrick-next" target="_blank">
                            <div className="btn btn-icon btn-pills btn-primary"><FiUser className="feLink icon-sm"/></div>
                        </Link>
                    </li>
                </ul>
                ...
                <div id="navigation" className={`${toggle ? 'd-block' : 'd-none'}`}>
                    <ul className={`navigation-menu nav-right ${navlight ? 'nav-light' : ''}`}>
                        <li className={`${current === '/index-crypto' ? 'active' : ''}`}><Link href="/index-crypto" className="sub-menu-item">Home</Link></li>
                        <li className={`${current === '/crypto-about' ? 'active' : ''}`}><Link href="/crypto-about" className="sub-menu-item"> About Us</Link></li>
                        <li className={`${current === '/crypto-market' ? 'active' : ''}`}><Link href="/crypto-market" className="sub-menu-item">Market</Link></li>
                        <li className={`${current === '/crypto-token' ? 'active' : ''}`}><Link href="/crypto-token" className="sub-menu-item"> Token</Link></li>
                        <li className={`has-submenu parent-parent-menu-item ${['/page-item','/crypto-services','/crypto-faqs','/crypto-whitepaper','/blog-item','/crypto-blog','/crypto-blog-detail','/auth-item','/auth-bs-login','/auth-bs-signup','/auth-bs-reset'].includes(current) ? 'active' : ''}`}>
                            <Link href="#" onClick={()=>setManu(manu === '/page-item' ? '' : '/page-item')}>Pages</Link><span className="menu-arrow"></span>
                            <ul className={`submenu ${['/page-item','/crypto-services','/crypto-faqs','/crypto-whitepaper','/blog-item','/crypto-blog','/crypto-blog-detail','/auth-item','/auth-bs-login','/auth-bs-signup','/auth-bs-reset'].includes(manu) ? 'open' : ''}`}>
                                <li className={`${current === '/crypto-services' ? 'active' : ''}`}><Link href="/crypto-services" className="sub-menu-item"> Features</Link></li>
                                <li className={`${current === '/crypto-faqs' ? 'active' : ''}`}><Link href="/crypto-faqs" className="sub-menu-item">FAQs </Link></li>
                                <li className={`${current === '/crypto-whitepaper' ? 'active' : ''}`}><Link href="/crypto-whitepaper" className="sub-menu-item">Whitepaper </Link></li>
                                <li className={`has-submenu parent-menu-item ${['/blog-item','/crypto-blog','/crypto-blog-detail'].includes(current) ? 'active' : ''}`}><Link href="#" onClick={()=>setManu(manu === '/blog-item' ? '' : '/blog-item')}> Blog </Link><span className="submenu-arrow"></span>
                                    <ul className={`submenu ${['/blog-item','/crypto-blog','/crypto-blog-detail'].includes(manu) ? 'open' : ''}`}>
                                        <li className={`${current === '/crypto-blog' ? 'active' : ''}`}><Link href="/crypto-blog" className="sub-menu-item"> Blog </Link></li>
                                        <li className={`${current === '/crypto-blog-detail' ? 'active' : ''}`}><Link href="/crypto-blog-detail" className="sub-menu-item">Blog Detail</Link></li>
                                    </ul> 
                                </li>
                                <li className={`has-submenu parent-menu-item ${['/auth-item','/auth-bs-login','/auth-bs-signup','/auth-bs-reset'].includes(current) ? 'active' : ''}`}><Link href="#" onClick={()=>setManu(manu === '/auth-item' ? '' : '/auth-item')}> Auth pages </Link><span className="submenu-arrow"></span>
