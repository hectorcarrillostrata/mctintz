...
import { blogTravelImage } from '../../data/blogData'
...
export default function BlogFooterSlider() {

    let [open, setOpen] = useState(false);
    let [activeIndex, setActiveIndex] = useState(0)

    const slides = blogTravelImage.map((image) => ({ src: image }));
            ...
            <div className="col-12 px-0">
                <div className="tiny-ten-item">
                    <TinySlider settings={settings}>
                        {blogTravelImage.map((item,index)=>{
                            return(
