import { clenerBlogData } from '@/app/data/blogData'
...
export default function ClenerBlog() {
  return (
        <div className="row">
            {clenerBlogData.slice(0,3).map((item,index)=>{
                return(
                    <div className="col-lg-4 col-md-6 mt-4 pt-2" key={index}>
                        <div className="card blog blog-primary rounded border-0 shadow">
                            ...
                            <div className="card-body content">
                                ...
                                <p className="text-muted mb-0">The advantage of its Latin origin and the relative</p>
