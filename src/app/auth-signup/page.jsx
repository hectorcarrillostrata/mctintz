            ...
            <div className="row align-items-center">
                <div className="col-lg-7 col-md-6">
                    <div className="me-lg-5">   
                        <Image src="/images/user/signup.svg" width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid d-block mx-auto" alt=""/>
                    </div>
                </div>
                            ...
                            <form className="login-form mt-4">
                                <div className="row">
                                    ...
                                    <div className="mx-auto">
                                        <p className="mb-0 mt-3"><small className="text-dark me-2">Already have an account ?</small> <Link href="/auth-login" className="text-dark fw-bold">Sign in</Link></p>
                                    </div>
                                </div>
                            </form>
                        </div>
