...
import { propertyData } from '@/app/data/real-estate'

export default function PropertyDetail(props) {
    let data = propertyData.find((item)=>item.id === parseInt(props.params.id))
  return (
    <>
                  ...
                  <div className="work-detail">
                      ...
                      <ul className="list-unstyled mt-3 d-flex align-items-center">
                          <li className="d-flex align-items-center me-3">
                              ...
                              <span className="text-muted fs-5">{data?.sqf}</span>
                          </li>

                          <li className="d-flex align-items-center me-3">
                              <LuBedDouble className="fs-4 me-1 text-primary"/>
                              <span className="text-muted fs-5">{data?.beds}</span>
                          </li>

                          <li className="d-flex align-items-center">
                              <LuBath className="fs-4 me-1 text-primary"/>
                              <span className="text-muted fs-5">{data?.baths}</span>
                          </li>
                      </ul>
