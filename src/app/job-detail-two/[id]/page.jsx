...
export default function JobDetailTwo({params}) {
          ...
          <div className="row">    
              <div className="col-lg-8 col-md-7 col-12">
                  <div className="d-md-flex align-items-center">
                      <Image src={data?.image} width={80} height={80} className="avatar avatar-large p-4 bg-white shadow-md rounded-pill" alt=""/>
                      ...
                      <div className="ms-md-4 mt-4 mt-sm-0">
                          ...
                          <ul className="list-unstyled mb-0">
                              <li className="list-inline-item mb-0 text-primary me-3"><i className="mdi mdi-map-marker text-warning me-2"></i>{data?.location}</li>
                              <li className="list-inline-item mb-0 text-primary"><i className="mdi mdi-office-building text-warning me-2"></i>{data?.company}</li>
                          </ul>
                      </div>
                  </div>
