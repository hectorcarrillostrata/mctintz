...
export default function BlogVimeoPost() {
  return (
    <>
     <BlogNavbar/> 
          ...
          <div className="row">
              <div className="col-lg-8 col-md-7">
                  <div className="card border-0 shadow rounded overflow-hidden">
                      <iframe src="https://player.vimeo.com/video/99025203" allow="autoplay; encrypted-media" style={{height:'433px'}} allowFullScreen></iframe>

                      <div className="card-body">
                          <div className="text-center">
                              <span className="badge text-bg-primary">Vimeo</span>
                              <h4 className="mt-3">The power of video at your fingertips</h4>

                              <ul className="list-unstyled mt-3">
                                  <li className="list-inline-item user text-muted me-2"><i className="mdi mdi-account"></i> Cristina Jota</li>
                                  <li className="list-inline-item date text-muted"><i className="mdi mdi-calendar-check"></i> 13th March, 2026</li>
                              </ul>
                          </div>
