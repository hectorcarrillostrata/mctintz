            ...
            <div className="col-lg-8 col-md-6">
                <div className="row">
                  {blogData.map((item,index)=>{
                    return(
                      <div className="col-lg-6 col-md-12 mb-4 pb-2" key={index}>
                          <div className="card blog blog-primary rounded border-0 shadow">
                              ...
                              <div className="author">
                                  <small className="user d-block"><LuUser className="me-1"></LuUser> Calvin Carlo</small>
                                  <small className="date"><MdOutlineCalendarMonth className="me-1"/> {item.date}</small>
                              </div>
                          </div>
                      </div>
                    )
