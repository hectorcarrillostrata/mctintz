              ...
              <div className="col-lg-12 text-center">
                  <div className="pages-heading">
                      ...
                      <ul className="list-unstyled mt-4 mb-0">
                          ...
                          <li className="list-inline-item h6 date text-muted"> <span className="text-dark">Date :</span> 13th Sep, 2026</li>
                      </ul>
                  </div>
              </div> 
          </div>
                              ...
                              <div className="card work-details rounded bg-light border-0">
                                  <div className="card-body">
                                      ...
                                      <dl className="row mb-0">
                                          ...
                                          <dd className="col-md-8 col-7 text-muted">13th Sep 2023</dd>
