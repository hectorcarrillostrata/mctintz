...
import { corporateBlog } from '@/app/data/blogData'

export default function BlogDetail({params}) {
    let {id} = use(params)
    let data = corporateBlog.find((item) => item.id === parseInt(id))
  return (
    <>
      <CorporateNavbar/>
                ...
                <div className="col-lg-12 text-center">
                    <div className="pages-heading title-heading">
                        <div className="pages-heading">
                            <h2 className="text-white title-dark"> {data?.title} </h2>
                            <ul className="list-unstyled mt-4">
                                <li className="list-inline-item h6 user text-white-50 me-2"><i className="mdi mdi-account"></i> Calvin Carlo</li>
                                <li className="list-inline-item h6 date text-white-50"><i className="mdi mdi-calendar-check"></i>{data?.date}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-lg-8 col-md-6">
                    <div className="me-lg-5">
                        ...
                        <ul className="list-unstyled d-flex justify-content-between mt-4">
                            ...
                            <li className="list-inline-item date text-muted"><LuCalendarDays className="text-dark"/>{data?.date}</li>
                        </ul>
                        
                        <Image src={data?.image} width={0} height={0} sizes='100vw' style={{width:'100vw', height:'auto'}} className="img-fluid rounded-md shadow" alt=""/>
