  ...
  return (
      <div style={{marginTop: '50px'}}>
        <table cellPadding="0" cellSpacing="0" style={{fontFamily: 'Nunito, sans-serif', fontSize: '15px', fontWeight: '400', maxWidth: '600px', border: 'none', margin: '0 auto', borderRadius: '6px', overflow: 'hidden', backgroundColor:' #fff', boxShadow: '0 0 3px rgba(60, 72, 88, 0.15)'}}>
            <thead>
                <tr style={{backgroundColor: '#2f55d4', padding: '3px 0', lineHeight: '68px', textAlign: 'center', color: '#fff', fontSize: '24px', letterSpacing: '1px'}}>
                    <th scope="col"><Image src="/images/logo-light.png" width={134} height={24} alt=""/></th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    <td style={{padding: '24px'}}>
                        <div style={{display: 'block', overflowX: 'auto', scrolling: 'touch', borderRadius: '6px', boxShadow: '0 0 3px rgba(60, 72, 88, 0.15)'}}>
                            <table cellPadding="0" cellSpacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style={{textAlign: 'left', padding: '12px', borderTop: '1px solid #dee2e6'}}>Landrick Template</td>
                                    ...
                                    <tr style={{backgroundColor:' rgba(47, 85, 212, 0.2)', color: '#2f55d4', overflowX: 'hidden'}}>
