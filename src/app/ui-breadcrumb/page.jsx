          ...
          <div className="row mt-5 justify-content-center">
              <div className="col-lg-12 text-center">
                  <div className="pages-heading">
                      <h4 className="title mb-0"> Breadcrumbs </h4>
                  </div>
              </div> 
          </div>
                          ...
                          <div className="component-wrapper rounded shadow">
                              ...
                              <div className="p-4">
                                  <h6 className="text-muted mb-4 pb-2">Ex. <br/> 
                                      <pre><code className="text-danger">
                                        &lt;nav aria-label="breadcrumb" className="d-inline-block"&gt;<br/>
                                            &nbsp;&nbsp;&nbsp;&lt;ul className="breadcrumb rounded shadow mb-0 px-4 py-2 bg-white"&gt;<br/>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li className="breadcrumb-item"&gt;&lt;Link href="/"&gt;Landrick&lt;/Link&gt;&lt;/li&gt;<br/>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li className="breadcrumb-item"&gt;&lt;Link href="#"&gt;Docs&lt;/Link&gt;&lt;/li&gt;<br/>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li className="breadcrumb-item active" aria-current="page"&gt;Components&lt;/li&gt;<br/>
                                            &nbsp;&nbsp;&nbsp;&lt;/ul&gt;<br/>
                                        &lt;/nav&gt;<br/>
                                        </code></pre>
                                  </h6>
                                  ...
                                  <nav aria-label="breadcrumb" className="d-inline-block">
                                      <ul className="breadcrumb rounded shadow mb-0 px-4 py-2">
                                          <li className="breadcrumb-item"><Link href="/">Landrick</Link></li>
                                          <li className="breadcrumb-item"><Link href="#">Docs</Link></li>
