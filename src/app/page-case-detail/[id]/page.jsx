...
export default function PageCaseDetail({params}) {
    const id = use(params)
    let data = casesData.find((item)=>item.id === parseInt(id))
  return (
    <>
     <Navbar/> 
              ...
              <div className="col-lg-8 col-md-10">
                  <div className="section-title">
                      <div className="text-center">
                          ...
                          <Image src={data?.image} width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid rounded-md shadow-md" alt=""/>
                      </div>
